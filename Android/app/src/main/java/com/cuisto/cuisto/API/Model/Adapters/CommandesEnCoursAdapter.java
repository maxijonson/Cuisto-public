...
import com.cuisto.cuisto.UI.CommandeEnCoursFragment;
    ...
    public class CommandesEnCoursAdapter extends RecyclerView.Adapter<CommandesEnCoursAdapter.ViewHolder> {
    private Context context;
    private CommandeEnCoursFragment fragment;
    private Commande[] data;

    public CommandesEnCoursAdapter(Commande[] data, Context context, CommandeEnCoursFragment fragment) {
        ...
        viewHolder.rl_ListeCommandes.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                new AlertDialog.Builder(context)
                        ...
                        .setMessage("Voulez vous vraiment indiquer cette commande comme prête?")
