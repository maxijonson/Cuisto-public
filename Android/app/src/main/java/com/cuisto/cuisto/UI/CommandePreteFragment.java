...
import com.cuisto.cuisto.API.Model.Adapters.CommandePreteAdapter;
...
public class CommandePreteFragment extends Fragment {

    RecyclerView recyclerEnCours;
    RecyclerView recyclerPretes;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        ((MainActivity) getActivity()).setActionBarTitle("Commandes prêtes");
        loadPrete();
    }
                ...
                if (response.isSuccessful()) {
                    ...
                    if (getActivity() != null) {
                        ...
                        if (recyclerEnCours != null) {
                            ...
                            CommandePreteAdapter adapter = new CommandePreteAdapter(data, getContext(), CommandePreteFragment.this);
    ...
    public void readyCommande(int id) {
        CommandeClient client = ServiceGenerator.retrofit.create(CommandeClient.class);
        Call<Commandes> list = client.PatchCommande(Authentification.getXauth(), id, new Commande("Complete"));
